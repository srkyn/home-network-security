...
Kuma, Glance, opnDossier, Nuclei, Trivy, and CrowdSec.
...
on-demand scanning, and a one-page dashboard. OPNsense remains the enforcement
...
Security Operations, Threat Detection, OpenCanary, Nuclei, Trivy, CrowdSec,
...
- Built a lightweight Proxmox security control plane for an OPNsense network using LXCs, VictoriaLogs, NetAlertX, OpenCanary, Uptime Kuma, Glance, and on-demand Nuclei/Trivy/opnDossier runners.
